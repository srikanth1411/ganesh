document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async event => {
        ...
        try {
            ...
            const winnerMessage = `🙏 *Sri Ganeshaya Namah* 🙏\n\nNamaskaram ${name} garu,\n\nCongratulations! 🎉 You have successfully won the *Sri Ganesh Laddu Auction* with a winning bid of *₹${amount.toLocaleString('en-IN')}*.\n\nYour winner photo and signature have been recorded successfully.\n\nMay Lord Ganesha bless you and your family with happiness, prosperity, good health, and success. 🙏\n\n*Ganapati Bappa Morya!* ❤️\n\nThanks & Regards,\nSikhwada Youth Association`;
